...
class RealEnv:
    ...
    def setup_dxl(self):
        self.dxl_client = DynamixelClient(
            [1, 2], port="/dev/ttyDXL_wheels", lazy_connect=True
        )
    ...
    def get_base_vel_t265(self):
        ...
        base_linear_vel = np.sqrt(pose.velocity.z**2 + pose.velocity.x**2) * (
    ...
    def get_tracer_vel(self):
        linear_vel, angular_vel = (
            self.tracer.GetLinearVelocity(),
            self.tracer.GetAngularVelocity(),
        )
