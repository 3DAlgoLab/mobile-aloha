...
def main():
    ...
    all_bots = (
        [puppet_bot_left, puppet_bot_right, master_bot_left, master_bot_right]
        if args.all
        else [puppet_bot_left, puppet_bot_right]
    )
    ...
    all_positions = (
        [puppet_sleep_position] * 2
        + [master_sleep_left_position, master_sleep_right_position]
        if args.all
        else [puppet_sleep_position] * 2
    )
